    ...
    return (
        <div id="home" className={mainCSS.container}>
            <div className={mainCSS.content}>
                ...
                <ul>
                    <a href="http://www.github.com/Sleamy" target="_blank" rel="noreferrer"><li className={mainCSS.iconContainer}>
                        <FaGithub className={mainCSS.icon}></FaGithub>
                        <h6>Github</h6>
                    </li></a>
                    <a href="https://au.linkedin.com/in/sean-leamy-30619978" target="_blank" rel="noreferrer"><li className={mainCSS.iconContainer}>
                        <FaLinkedinIn className={mainCSS.icon}></FaLinkedinIn>
                        <h6>LinkedIn</h6>
                    </li></a>
                    <a href={Resume} target="_blank" rel="noreferrer"><li className={mainCSS.iconContainer}>
